...
import { SplashScreen, SignIn, SignUp, Onboarding } from '../screens';
...
const RootStackScreen = ({ navigation }) => {
  ...
  return (
    <RootStack.Navigator initialRouteName={routeName}>
      <RootStack.Screen name="Onboarding" component={Onboarding} options={{ header: () => null }} />
      <RootStack.Screen name="SplashScreen" component={SplashScreen} options={{ header: () => null }} />
